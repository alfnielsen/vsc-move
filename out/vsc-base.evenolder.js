...
const relatrivePathToAbsolutePath = (path, pathRelatriveToPath, rootPath) => {
    ...
    // #1: pathRelatriveToPath: '../file2'
    // #2: pathRelatriveToPath: 'file2'
    // #3: pathRelatriveToPath: 'sub/file2'
    // #4: pathRelatriveToPath: 'root/modules/file3'
    let dir = methods.getDirFromPath(path);
    // #1,2,3,4: dir: 'root/modules'
    if (dir[dir.length - 1] !== '/') {
        dir += '/';
    }
    // #1,2,3,4: dir: 'root/modules/'
    const relativePath = dir + pathRelatriveToPath;
    // #1: relativePath: 'root/modules/../file2'
    // #2: relativePath: 'root/modules/file2'
    // #3: relativePath: 'root/modules/sub/file2'
    // #4: relativePath: 'root/modules/root/modules/file3'
...
exports.intercept = {
    ask: (...args) => exports.interceptMethods({ ask: exports.interceptFactories.ask.call(null, args) }),
    doesExists: exports.interceptMethods({ doesExists: doesExists_interception_factory }),
    findFilePaths: exports.interceptMethods({ findFilePaths: findFilePaths_interception_factory }),
    getActiveOpenPath: exports.interceptMethods({ getActiveOpenPath: getActiveOpenPath_interception_factory }),
    getConfig: exports.interceptMethods({ getConfig: getConfig_interception_factory }),
    getFileContent: exports.interceptMethods({ getFileContent: getFileContent_interception_factory }),
    getPackageDependencies: exports.interceptMethods({ getPackageDependencies: getPackageDependencies_interception_factory }),
    getRootPath: exports.interceptMethods({ getRootPath: getRootPath_interception_factory }),
    isDir: exports.interceptMethods({ isDir: isDir_interception_factory }),
    realPath: exports.interceptMethods({ realPath: realPath_interception_factory })
};
//# sourceMappingURL=vsc-base.evenolder.js.map