...
suite('Vsc base Tests', function () {
    ...
    suite('absolutePathToSubRalative', () => {
        test(' 1', () => {
            const r1 = vsc_base_1.default.absolutePathToSubRalative('c:/root/modules/file1.js', 'modules/file2.js', 'c:/root/');
    ...
    suite('cleanPath', () => {
        test('1', () => {
            const r1 = vsc_base_1.default.cleanPath('c:/root/modules/../file1.js');
        ...
        test('4', () => {
            const r1 = vsc_base_1.default.cleanPath('c:/root/./file1.js');
            assert.equal(r1, 'c:/root/file1.js');
        });
        test('5', () => {
            const r1 = vsc_base_1.default.cleanPath('c:/root/../sub1/sub2/sub3/sub4/../sub4/../../sub3/sub4/file1.js');
            assert.equal(r1, 'c:/sub1/sub2/sub3/sub4/file1.js');
        });
    });
    suite('camalcaseToKebabcase', () => {
        test('1', () => {
            const r1 = vsc_base_1.default.camalcaseToKebabcase('myNameIsName');
        ...
        test('3', () => {
            const r1 = vsc_base_1.default.camalcaseToKebabcase('my.NameIsName');
            assert.equal(r1, 'my.-name-is-name');
        });
    });
    suite('splitPath', () => {
        test('1', () => {
            const r1 = vsc_base_1.default.splitPath('c:/root/sub/file');
            assert.equal(r1[0], 'c:/root/sub');
            assert.equal(r1[1], 'file');
        });
        test('2', () => {
            const r1 = vsc_base_1.default.splitPath('sub/file');
            assert.equal(r1[0], 'sub');
            assert.equal(r1[1], 'file');
        });
        test('3', () => {
            const r1 = vsc_base_1.default.splitPath('sub/file.js');
            assert.equal(r1[0], 'sub');
            assert.equal(r1[1], 'file.js');
        });
        test('4', () => {
            const r1 = vsc_base_1.default.splitPath('c:/sub/sin/./file.js');
    ...
    suite('getJsonParts', () => {
        ...
        test('1', () => {
            const r = vsc_base_1.default.getJsonParts(j, 't.t2.n');
            assert.equal(r, 'Yes');
        });
        test('2', () => {
            const r = vsc_base_1.default.getJsonParts(j, 't.t2.y');
            assert.equal(r, undefined);
        });
        test('3', () => {
            const r = vsc_base_1.default.getJsonParts(j, 't.t3.d.e.d');
            assert.equal(r, undefined);
        });
        test('4', () => {
            const r = vsc_base_1.default.getJsonParts(j, 't.nb');
            assert.equal(r, '1');
        });
        test('5', () => {
            const r = vsc_base_1.default.getJsonParts(j, 'j');
            assert.equal(r, false);
        });
        test('6', () => {
            const r = vsc_base_1.default.getJsonParts(j, 'f.d.f');
            assert.equal(r.length, 1);
            assert.equal(r[0], 1);
        });
        test('7', () => {
            const r = vsc_base_1.default.getJsonParts(j, 'f.f');
            assert.equal(r, false);
        });
        test('8', () => {
            const r = vsc_base_1.default.getJsonParts(j, 'f.t');
            assert.equal(r, true);
        });
        test('9', () => {
            const r = vsc_base_1.default.getJsonParts(j, 'f.n');
            assert.equal(r, 12);
        });
    });
    suite('isSubPath', () => {
        test('1', () => {
            const r = vsc_base_1.default.isSubPath('c:/root/sub/sub2/files', 'c:/root');
            assert.equal(r, true);
        });
        test('2', () => {
            const r = vsc_base_1.default.isSubPath('c:/other/sub/sub2/files', 'c:/root');
            assert.equal(r, false);
        });
        test('3', () => {
            const r = vsc_base_1.default.isSubPath('c:/root/sub/sub2/files', 'c:/root/');
        ...
        test('4', () => {
            const r = vsc_base_1.default.isSubPath('c:/root/sub/sub2/files', 'c:/root/s');
            assert.equal(r, false);
        });
    });
    suite('toCamelcase', () => {
        test('1', () => {
            const r = vsc_base_1.default.toCamelcase('my-css-name');
        ...
        test('3', () => {
            const r = vsc_base_1.default.toCamelcase('MyName');
